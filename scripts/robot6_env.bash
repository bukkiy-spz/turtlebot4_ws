...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  echo "  source scripts/robot6_env.bash"
  exit 1
fi
...
export TB4_DISCOVERY_SERVER="192.168.11.26:11811;"
export TB4_DISCOVERY_SERVER_ID=6

tb4_setup_robot_env "robot6" "0" "192.168.11.26:11811;" "6" "${BASH_SOURCE[0]}"
