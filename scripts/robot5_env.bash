...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  echo "  source scripts/robot5_env.bash"
  exit 1
fi
...
export TB4_DISCOVERY_SERVER="192.168.11.25:11811;"
export TB4_DISCOVERY_SERVER_ID=5

tb4_setup_robot_env "robot5" "0" "192.168.11.25:11811;" "5" "${BASH_SOURCE[0]}"
