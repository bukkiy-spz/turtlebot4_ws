...
def generate_launch_description():
    ...
    ign_resource_path = SetEnvironmentVariable(
        ...
        value=[
            # tb4_square custom world
            os.path.join(pkg_tb4_square, "worlds"),
            ":",
            # tb4_square custom models
            os.path.join(pkg_tb4_square, "models"),
            ":",
            # official TurtleBot4 / Create3 resources
